...
<head>
    ...
    <title>Library CRUD - @yield('title')</title>
</head>
<style>
            ...
            <div class="container-fluid">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Library</h5>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item d-flex justify-content-center">
                                <a class="nav-link d-flex align-items-center {{Route::current()->getName() ==='formCreateBook' ? 'active' : ''}}" href="{{route('formCreateBook')}}">Create Book</a>
                            </li>
                        </ul>
                    </div>
                </div>
